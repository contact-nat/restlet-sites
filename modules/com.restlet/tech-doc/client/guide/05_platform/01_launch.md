...
Restlet Client can be used as an online service from <a href="https://client.restlet.com/" target="_blank">client.restlet.com <i class="fa fa-external-link" aria-hidden="true"></i></a> or installed within Chrome from the <a href="https://chrome.google.com/webstore/detail/restlet-client/aejoelaoggembcahagimdiliamlcdmfm" target="_blank">Chrome Web Store <i class="fa fa-external-link" aria-hidden="true"></i></a>.
...
The tool is also available for offline or online use as a Chrome extension and can be installed from the <a href="https://chrome.google.com/webstore/detail/restlet-client/aejoelaoggembcahagimdiliamlcdmfm">Chrome Web Store <i class="fa fa-external-link" aria-hidden="true"></i></a>.
